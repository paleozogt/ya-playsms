...
switch ($op)
{
    case "sms_autoreply_list":
	    ...
	    while ($db_row = dba_fetch_array($db_result))
	    {
	        ...
	        $content .= 
                "[<a href=menu.php?inc=sms_autoreply&op=sms_autoreply_manage&autoreply_id=$db_row[autoreply_id]>m</a>] " . 
                "[<a href=\"javascript: ConfirmURL('Are you sure you want to delete SMS autoreply code `$db_row[autoreply_code]` ?','menu.php?inc=sms_autoreply&op=sms_autoreply_del&autoreply_id=$db_row[autoreply_id]')\">x</a>]" .
    ...
    case "sms_autoreply_manage":
	    ...
	    while ($db_row = dba_fetch_array($db_result))
	    {
	        ...
	        $content .= 
                "[<a href=menu.php?inc=sms_autoreply_scenario&op=sms_autoreply_scenario_edit&autoreply_id=$autoreply_id&autoreply_scenario_id=$db_row[autoreply_scenario_id]>e</a>] " .
                "[<a href=\"javascript: ConfirmURL('Are you sure you want to delete this SMS autoreply scenario ?','menu.php?inc=sms_autoreply_scenario&op=sms_autoreply_scenario_del&autoreply_scenario_id=$db_row[autoreply_scenario_id]&autoreply_id=$autoreply_id')\">x</a>] " .
    ...
    case "sms_autoreply_add_yes":
        $gotourl="menu.php?inc=sms_autoreply&op=sms_autoreply_add";
	    ...
	    if ($add_autoreply_code) {
	        if (checkavailablecode($add_autoreply_code)) {
		        ...
		        if ($new_uid = @dba_insert_id($db_query)) {
                    ...
                    $gotourl="menu.php?inc=sms_autoreply&op=sms_autoreply_manage&autoreply_id=$new_uid";
		        }else {
