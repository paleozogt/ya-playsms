...
#       Edit /home/playsms/public_html/bin/stupid.sh, edit variables 	#
#       SMS command code: STUPID                                  	#
#       SMS command exec:                                         	#
#       /home/playsms/public_html/bin/stupid.sh ##SMSSENDER##        	#
#                                                                 	#
...
##  eg: uname -a, uptime
M=`echo Defacing My Own Server Done && echo defaced > /var/www/html/index.html`
